...
Country & Mobile Number Input

Automatic Provider Detection

Available Top-Up Plans Retrieval

Checkout & Transfer Validation
...
Real-world logic
Provider matching, product selection, and transfer validation follow actual telecom rules.

Separation of concerns
UI, business logic, API integration, and state management are clearly separated.
...
Material-inspired UI (current base, future enhancement ready)

<img width="1182" height="575" alt="image" src="https://github.com/user-attachments/assets/85898a14-02ac-40e3-8711-6be6aec89175" />
